...
export default function NavigationBar() {
    ...
    const refreshOrStop = useTabStore((state) => state.refreshOrStop);
    const goHome = useTabStore((state) => state.goHome);
    const navigateTo = useTabStore((state) => state.navigateTo);
